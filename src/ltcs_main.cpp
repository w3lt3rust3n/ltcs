...
// CLI mode help
void ltcs_cli_help(string programName)
{
    cout << "\033[1;30m | Linux Terminal Cheat Sheets \033[0m\n"
        ...
        "\033[1;30m |\033[1;30m Usage:\t\t\033[0;31m" + programName + "\033[0m \033[33m-option\033[0m \n"
        "\033[1;30m |\n"
        ...
        "\033[1;30m |\t\033[0;33m-c\033[0m \t\tCreate a custom cheat sheet\n"
        "\033[1;30m |\t\033[0;33m-x\033[0m \t\tStore a custom command line\n"
...
void ltcs_show_all_available_cheatsheet(string programName)
{
    cout << "\033[1;30m | Linux Terminal Cheat Sheets \033[0m\n"
        "\033[1;30m |\033[0m\033[1;30m -------------------------------------\033[0m\n"
        "\033[1;30m |\033[1;30m Usage:\t\033[0;31m" + programName + "\033[0m \033[33m-s\033[0m (one of the sheet bellow)\033[0m \n"
        "\033[1;30m |\033[0m\n"
...
void all_cheatsheet_display(ElCheats *elCheats)
{
...
int main(int argc, char *argv[])
{
    ...
    */
    if(argc > MAX_CLI)
    {
        cout << "Error: Too much arguments. Use -h\n";
        return 0;
    }
    else
    {
        ...
        */
        ...
        {
            ltcs_show_all_available_cheatsheet("ltcs");
        }
        ...
        else if(strcmp("-s", argv[1]) == 0)
        {
            ...
            */
            ...
            {
                all_cheatsheet_display(elCheats);
            }
            else
            {
                arg = argv[2];
                cout << "\033[31mError: " + arg + " is not a known sheet. Use -a.\033[0m\n";
                return 0;
            }
        }
        else
